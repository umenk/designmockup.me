...
<article>
            ...
            <p style="text-align: justify;">The following is the privacy policy of google, so with that I will implement on my blog by e-mail address&nbsp;contact@{{ $site['url'] }}.</p>
...
<p style="text-align: justify;">The contents of this statement may be altered at any time, at our discretion. If you have any questions regarding the privacy policy of&nbsp;{{ $site['url'] }}&nbsp;then you may&nbsp;<a href="/contact">contact us</a>&nbsp;at contact@{{ $site['url'] }}.</p>
</article>
